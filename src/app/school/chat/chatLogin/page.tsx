...
const ChatLogin = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen gap-6 bg-gray-50 px-4">
      <h1 className="text-3xl font-bold text-gray-800">Global Chat 로그인</h1>
      <form
      ...
      >
        ...
        <button type="submit" className="bg-blue-500 text-white font-semibold py-2 rounded-md hover:bg-blue-600">
          채팅 입장
        </button>
      </form>
    </div>
