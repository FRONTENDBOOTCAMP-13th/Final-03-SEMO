...
export default function MyPageLayout({ children, modal }: MyPageLayoutProps) {
  return (
    <div className="min-h-screen bg-white w-full max-w-md mx-auto relative">
      {/* 공통 헤더 */}
      ...
      <nav className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-md bg-white border-t border-gray-200 z-10">
        <div className="flex h-16">
          <Link href="/home" className="flex-1 flex flex-col items-center justify-center py-2 px-1">
            <Home className="w-5 h-5 text-gray-400 mb-1" />
            <div className="text-xs text-gray-400 font-medium">홈</div>
          </Link>
          <Link href="/market" className="flex-1 flex flex-col items-center justify-center py-2 px-1">
            <ShoppingBag className="w-5 h-5 text-gray-400 mb-1" />
            <div className="text-xs text-gray-400 font-medium">상품</div>
          </Link>
          <Link href="/getherings" className="flex-1 flex flex-col items-center justify-center py-2 px-1">
            <Users className="w-5 h-5 text-gray-400 mb-1" />
            <div className="text-xs text-gray-400 font-medium">공동구매</div>
          </Link>
          <Link href="/chat" className="flex-1 flex flex-col items-center justify-center py-2 px-1">
            <MessageSquare className="w-5 h-5 text-gray-400 mb-1" />
            <div className="text-xs text-gray-400 font-medium">채팅</div>
          </Link>
          <Link href="/myPage" className="flex-1 flex flex-col items-center justify-center py-2 px-1">
